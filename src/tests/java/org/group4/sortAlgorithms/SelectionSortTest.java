...
public class SelectionSortTest {
    ...
    void testSortAscendingNumbers() {
        ...
        selectionSort = new SelectionSort(configs);
        selectionSort.setVisualizer(visualizerMock);

        // Execute the algorithm
        selectionSort.sort(visualizerMock);

        // Verify that the list is sorted correctly
        List<String> expected = Arrays.asList("1", "2", "3", "5", "8");
        assertEquals(expected, selectionSort.getElements());
    }
